...
interface AlbumsService {
     ...
     */
    @PUT("me/albums")
    fun saveAlbumsForCurrentUser(@Query("ids") ids: String? = null): Call<Result>
     ...
     */
    @DELETE("me/albums")
    fun removeUsersSavedAlbums(@Query("ids") ids: String? = null): Call<Result>
    ...
    fun checkUsersSavedAlbums(@Query("ids") ids: String? = null): Call<Array<Boolean?>>
