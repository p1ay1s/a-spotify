...
import com.niki.spotify.web.models.AudioFeaturesTrack
import com.niki.spotify.web.models.AudioFeaturesTracks
...
import com.niki.spotify.web.models.Recommendations
...
import com.niki.spotify.web.models.SeedsGenres
...
import com.niki.spotify.web.models.TracksToRemoveWithPosition
 ...
 * 弃用
 *
 * Related Artists（相关艺术家推荐）
 *
 * Recommendations（个性化推荐）
 *
 * Audio Features（音频特征分析）
 *
 * Audio Analysis（音频深度分析）
 *
 * Get Featured Playlists（获取精选播放列表）
 *
 * Get Category's Playlists（获取分类下的播放列表）
 */
...
interface SpotifyService {
    ...
    fun getBewReleases(): Call<NewReleases>
    ...
    @Deprecated("")
    fun seedsGenres(): Call<SeedsGenres>
     ...
     */
    @GET("me/top/artists")
    fun topArtists(): Call<Pager<Artist?>>
    ...
    @GET("me/top/tracks")
    fun topTracks(): Call<Pager<Track?>>
