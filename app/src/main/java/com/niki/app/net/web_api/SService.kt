...
//     * @see [Get User's Public Profile](https://developer.spotify.com/documentation/web-api/reference/get-users-profile/)
//     */
//    @GET("users/{id}")
...
//     * [endpoint documentation](https://developer.spotify.com/documentation/web-api/reference/get-a-list-of-current-users-playlists/)
...
//     * @param options Optional parameters. For list of supported parameters see
//     * [endpoint documentation](https://developer.spotify.com/documentation/web-api/reference/get-list-users-playlists/)
//     * @return List of user's playlists wrapped in a `Pager` object
//     * @see [Get a List of a User’s Playlists](https://developer.spotify.com/documentation/web-api/reference/get-list-users-playlists/)
//     */
...
//     * @param options    Optional parameters. For list of supported parameters see
//     * [endpoint documentation](https://developer.spotify.com/documentation/web-api/reference/get-playlist/)
//     * @return Requested Playlist.
//     * @see [Get a Playlist](https://developer.spotify.com/documentation/web-api/reference/get-playlist/)
//     */
...
//     * @param playlistId The Spotify ID for the playlist.
//     * @param options    Optional parameters. For list of supported parameters see
//     * [endpoint documentation](https://developer.spotify.com/documentation/web-api/reference/get-playlists-tracks/)
//     * @return List of playlist's tracks wrapped in a `Pager` object
//     * @see [Get a Playlist’s Tracks](https://developer.spotify.com/documentation/web-api/reference/get-playlists-tracks/)
//     */
...
//     * @see [Create a Playlist](https://developer.spotify.com/documentation/web-api/reference/create-playlist/)
//     */
...
//     * @see [Add Tracks to a Playlist](https://developer.spotify.com/documentation/web-api/reference/add-tracks-to-playlist/)
//     */
...
//     * @return A snapshot ID (the version of the playlist)
//     * @see [Remove Tracks from a Playlist](https://developer.spotify.com/documentation/web-api/reference/remove-tracks-playlist/)
//     */
...
//     * @see [Replace a Playlist’s Tracks](https://developer.spotify.com/documentation/web-api/reference/replace-playlists-tracks/)
//     */
...
//     * @return An empty result
//     * @see [Change a Playlist's Details](https://developer.spotify.com/documentation/web-api/reference/change-playlist-details/)
//     */
...
//     * @return An empty result
//     * @see [Follow a Playlist](https://developer.spotify.com/documentation/web-api/reference/follow-playlist/)
//     */
...
//     * @param playlistId The Spotify ID of the playlist
//     * @return An empty result
//     * @see [Unfollow a Playlist](https://developer.spotify.com/documentation/web-api/reference/unfollow-playlist/)
//     */
...
//     * @param userId     The Spotify user ID of the user who owns the playlist.
//     * @param playlistId The Spotify ID of the playlist
//     * @param body       The body parameters. For list of supported parameters see [endpoint documentation](https://developer.spotify.com/documentation/web-api/reference/reorder-playlists-tracks/)
//     * @return A snapshot ID (the version of the playlist)
//     * @see [Reorder a Playlist](https://developer.spotify.com/documentation/web-api/reference/reorder-playlists-tracks/)
//     */
//    @PUT("users/{user_id}/playlists/{playlist_id}/tracks")
...
//     * @see [Get an Album](https://developer.spotify.com/documentation/web-api/reference/get-album/)
//     */
//    @GET("albums/{id}")
...
//     * @param albumId The Spotify ID for the album.
//     * @param options Optional parameters. For list of supported parameters see
//     * [endpoint documentation](https://developer.spotify.com/documentation/web-api/reference/get-album/)
//     * @return Requested album information
//     * @see [Get an Album](https://developer.spotify.com/documentation/web-api/reference/get-album/)
//     */
//    @GET("albums/{id}")
...
//     * @see [Get Several Albums](https://developer.spotify.com/documentation/web-api/reference/get-several-albums/)
//     */
//    @GET("albums")
...
//     * @param albumIds A comma-separated list of the Spotify IDs for the albums
//     * @param options  Optional parameters. For list of supported parameters see
//     * [endpoint documentation](https://developer.spotify.com/documentation/web-api/reference/get-several-albums/)
//     * @return Object whose key is "albums" and whose value is an array of album objects.
//     * @see [Get Several Albums](https://developer.spotify.com/documentation/web-api/reference/get-several-albums/)
//     */
//    @GET("albums")
...
//     * @see [Get an Album’s Tracks](https://developer.spotify.com/documentation/web-api/reference/get-albums-tracks/)
//     */
...
//     * @param albumId The Spotify ID for the album.
//     * @param options Optional parameters. For list of supported parameters see
//     * [endpoint documentation](https://developer.spotify.com/documentation/web-api/reference/get-albums-tracks/)
//     * @return List of simplified album objects wrapped in a Pager object
//     * @see [Get an Album’s Tracks](https://developer.spotify.com/documentation/web-api/reference/get-albums-tracks/)
//     */
//    @GET("albums/{id}/tracks")
...
//     * @see [Get an Artist](https://developer.spotify.com/documentation/web-api/reference/get-artist/)
//     */
//    @GET("artists/{id}")
...
//     * @see [Get Several Artists](https://developer.spotify.com/documentation/web-api/reference/get-several-artists/)
//     */
//    @GET("artists")
...
//     * @see [Get an Artist's Albums](https://developer.spotify.com/documentation/web-api/reference/get-artists-albums/)
//     */
...
//     * @param artistId The Spotify ID for the artist.
//     * @param options  Optional parameters. For list of supported parameters see
//     * [endpoint documentation](https://developer.spotify.com/documentation/web-api/reference/get-artists-albums/)
//     * @return An array of simplified album objects wrapped in a paging object.
//     * @see [Get an Artist's Albums](https://developer.spotify.com/documentation/web-api/reference/get-artists-albums/)
//     */
//    @GET("artists/{id}/albums")
...
//     * @see [Get an Artist’s Top Tracks](https://developer.spotify.com/documentation/web-api/reference/get-artists-top-tracks/)
//     */
...
//     * @param artistId The Spotify ID for the artist.
//     * @return An object whose key is "artists" and whose value is an array of artist objects.
//     * @see [Get an Artist’s Related Artists](https://developer.spotify.com/documentation/web-api/reference/get-related-artists/)
//     */
...
//     * @see [Get a Track](https://developer.spotify.com/documentation/web-api/reference/get-track/)
//     */
//    @GET("tracks/{id}")
...
//     * @param trackId The Spotify ID for the track.
//     * @param options Optional parameters. For list of supported parameters see
//     * [endpoint documentation](https://developer.spotify.com/documentation/web-api/reference/get-track/)
//     * @return Requested track information
//     * @see [Get a Track](https://developer.spotify.com/documentation/web-api/reference/get-track/)
//     */
//    @GET("tracks/{id}")
...
//     * @return An object whose key is "tracks" and whose value is an array of track objects.
//     * @see [Get Several Tracks](https://developer.spotify.com/documentation/web-api/reference/get-several-tracks/)
//     */
//    @GET("tracks")
...
//     * @param trackIds A comma-separated list of the Spotify IDs for the tracks
//     * @param options  Optional parameters. For list of supported parameters see
//     * [endpoint documentation](https://developer.spotify.com/documentation/web-api/reference/get-several-tracks/)
//     * @return An object whose key is "tracks" and whose value is an array of track objects.
//     * @see [Get Several Tracks](https://developer.spotify.com/documentation/web-api/reference/get-several-tracks/)
//     */
//    @GET("tracks")
...
//     *
//     * @param options Optional parameters. For list of supported parameters see
//     * [endpoint documentation](https://developer.spotify.com/documentation/web-api/reference/get-list-featured-playlists/)
//     * @return n FeaturedPlaylists object with the featured playlists
//     * @see [Get a List of Featured Playlists](https://developer.spotify.com/documentation/web-api/reference/get-list-featured-playlists/)
//     */
...
//     *
//     * @param options Optional parameters. For list of supported parameters see
//     * [endpoint documentation](https://developer.spotify.com/documentation/web-api/reference/get-list-new-releases/)
//     * @return A NewReleases object with the new album releases
//     * @see [Get a List of New Releases](https://developer.spotify.com/documentation/web-api/reference/get-list-new-releases/)
//     */
...
//     * @see [Get a List of Categories](https://developer.spotify.com/documentation/web-api/reference/get-list-categories/)
//     */
...
//     * @see [Get a Spotify Category](https://developer.spotify.com/documentation/web-api/reference/get-category/)
//     */
...
//     * @see [Get playlists for a Spotify Category](https://developer.spotify.com/documentation/web-api/reference/get-categorys-playlists/)
//     */
...
//     *
//     * @param options Optional parameters. For list of supported parameters see
//     * [endpoint documentation](https://developer.spotify.com/documentation/web-api/reference/get-users-saved-tracks/)
//     * @return A paginated list of saved tracks
//     * @see [Get a User’s Saved Tracks](https://developer.spotify.com/documentation/web-api/reference/get-users-saved-tracks/)
//     */
//    @GET("me/tracks")
...
//     * @see [Check User’s Saved Tracks](https://developer.spotify.com/documentation/web-api/reference/check-users-saved-tracks/)
//     */
...
//     * @param ids A comma-separated list of the Spotify IDs for the tracks
//     * @return An empty result
//     * @see [Save Tracks for User](https://developer.spotify.com/documentation/web-api/reference/save-tracks-user/)
//     */
//    @PUT("me/tracks")
...
//     * @param ids A comma-separated list of the Spotify IDs for the tracks
//     * @return An empty result
//     * @see [Remove User’s Saved Tracks](https://developer.spotify.com/documentation/web-api/reference/remove-tracks-user/)
//     */
//    @DELETE("me/tracks")
...
//     *
//     * @param options Optional parameters. For list of supported parameters see
//     * [endpoint documentation](https://developer.spotify.com/documentation/web-api/reference/get-users-saved-albums/)
//     * @return A paginated list of saved albums
//     * @see [Get a User’s Saved Albums](https://developer.spotify.com/documentation/web-api/reference/get-users-saved-albums/)
//     */
//    @GET("me/albums")
...
//     * @see [Check User’s Saved Albums](https://developer.spotify.com/documentation/web-api/reference/check-users-saved-albums/)
//     */
...
//     * @param ids A comma-separated list of the Spotify IDs for the albums
//     * @return An empty result
//     * @see [Save Albums for User](https://developer.spotify.com/documentation/web-api/reference/save-albums-user/)
//     */
//    @PUT("me/albums")
...
//     * @param ids A comma-separated list of the Spotify IDs for the albums
//     * @return An empty result
//     * @see [Remove User’s Saved Albums](https://developer.spotify.com/documentation/web-api/reference/remove-albums-user/)
//     */
//    @DELETE("me/albums")
...
//     * @return An empty result
//     * @see [Follow Artists or Users](https://developer.spotify.com/documentation/web-api/reference/follow-artists-users/)
//     */
...
//     * @param ids A comma-separated list of the Spotify IDs for the users
//     * @return An empty result
//     * @see [Unfollow Artists or Users](https://developer.spotify.com/documentation/web-api/reference/unfollow-artists-users/)
//     */
...
//     * @see [Check if Current User Follows Artists or Users](https://developer.spotify.com/documentation/web-api/reference/check-current-user-follows/)
//     */
...
//     *
//     * @param options Optional parameters. For list of supported parameters see
//     * [endpoint documentation](https://developer.spotify.com/documentation/web-api/reference/get-followed-artists/)
//     * @return Object containing a list of artists that user follows wrapped in a cursor object.
//     * @see [Get User's Followed Artists](https://developer.spotify.com/documentation/web-api/reference/get-followed-artists/)
//     */
...
//     * @see [Search for an Item](https://developer.spotify.com/documentation/web-api/reference/search-item/)
//     */
//    @GET("search")
//    fun search(@Query("q") q: String?, @Query("type") type: String?): Call<SearchResult>
//
//    /**
//     * Get Spotify catalog information that match a keyword string.
//     * Search results include hits from all the specified item types.
...
//     * @param type    Valid types are: album , artist, playlist, track, show and episode.
//     * @param options Optional parameters. For list of supported parameters see
//     * [endpoint documentation](https://developer.spotify.com/documentation/web-api/reference/search-item/)
//     * @return A SearchResult object with item for each type
//     * @see [Search for an Item](https://developer.spotify.com/documentation/web-api/reference/search-item/)
//     */
//    @GET("search")
...
//     * [endpoint documentation](https://developer.spotify.com/documentation/web-api/reference/get-recommendations/)
...
//     *
//     * @param options Optional parameters. For list of available parameters see
//     * [endpoint documentation](https://developer.spotify.com/documentation/web-api/reference/get-users-top-artists-and-tracks/)
...
//     *
//     * @param options Optional parameters. For list of available parameters see
//     * [endpoint documentation](https://developer.spotify.com/documentation/documentation/web-api/reference/reference-beta/#endpoint-get-recently-played)
//     * @return Recently played tracks with their context (e.g: while playing a playlist)
//     */
//    @GET("me/player/recently-played")
//    fun getRecentlyPlayed(@QueryMap options: Map<String, String>): Call<CursorPager<RecentlyPlayedTrack?>>
//}